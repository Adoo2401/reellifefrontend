            ...
            <div className='mt-7 grid grid-cols-1 lg:gap-0 gap-5 lg:grid-cols-3'>
                <Card>
                    <div className='flex flex-col items-center space-y-3'>
                        ...
                        <h1 className='text-[#3a3a62] text-xl font-extrabold'>2.8%</h1>
                    </div>
                </Card>
                <Card>
                    <div className='flex flex-col items-center space-y-3'>
                ...
                <Card>
                    <div className='flex flex-col items-center space-y-3'>
                        <h1 className='text-[#3a3a62]  text-lg font-medium'>Avg. Response Rage <InfoCircleOutlined className="text-[0.8rem] ml-1 cursor-pointer relative bottom-[1.5px]" /></h1>
                        <h1 className='text-[#3a3a62] text-xl font-extrabold'>2.8%</h1>
                    </div>
                </Card>
            </div>
